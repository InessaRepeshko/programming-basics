/* 2.2 Клас для представлення простого дробу
 * Створити клас для представлення простого дробу.
 * Реалізувати конструктори, функцію скорочення дробу, а також перевантажити операції
 * +, -, *, /, <, <=, >, >=, введення та виведення.
 * В операторній функції виведення реалізувати максимально коректне виведення:
 * отримувати та виводити цілу частину для неправильних дробів, не виводити знаменник,
 * якщо він дорівнює 1 або чисельник дорівнює 0 тощо.
 * Здійснити читання двох дробів та демонстрацію скорочення дробів і всіх перевантажених операцій в функції main().
 * Примітка: не слід окремо зберігати цілу частину дробу,
 * оскільки вона завжди може бути розрахована з чисельника і знаменника. */
