/* 2. Вправа для контролю.
 * 4. Створити клас "Квадратне рівняння" з елементами даних – коефіцієнтами рівняння,
 * необхідними конструкторами та функціями доступу.
 * Реалізувати функцію знаходження коренів. */
...
int main() {
	...
	std::cout << "Changing the coefficients for the second equation:" << std::endl;
